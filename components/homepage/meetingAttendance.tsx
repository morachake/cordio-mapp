...
export default function MeetingAttendance ( ) {
    const users = [
        ...
        { id: 6, name: 'Mwanasiti Ali Ali', status: 'present' },
        { id: 7, name: 'Umaya Kassim Ali', status: 'present' },
        { id: 8, name: 'Kadzo Kassim Hassan', status: 'absent', markedBy: 'Faculty' },
        { id: 9, name: 'Ali Ali Ali', status: 'present', markedBy: 'Faculty' },
        { id: 10, name: 'Hassan Boi Ali', status: '' },
      ];
    return (
         <ScrollView>
